...
typedef enum IceResult
{
    ...
    ICE_RESULT_UPDATED_SRFLX_CANDIDATE_ADDRESS = 4,
    ICE_RESULT_SEND_RESPONSE_FOR_REMOTE_REQUEST = 5,
    ICE_RESULT_SEND_TRIGGERED_CHECK = 6,
    ICE_RESULT_SEND_RESPONSE_FOR_NOMINATION = 7,
    ICE_RESULT_CANDIDATE_PAIR_READY = 10,
